...
## [0.1.29] - 2021-04-16
Added manual tests for mysql and mssql data stores, added support for secure Kafka schema registries, give ownership of files to bucket owners when writing to S3, reduced code redundancy, added permissions for bootstrap files and ECS tags
...
- datapull_user_and_roles.tf - Added permissions for bootstrap files and ECS tags
